...
\033[1;91m<═══\033[1;41m\033[1;97m Created by MD SHOHAN \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by MD SHOHAN
\033[1;92m""")
...
# main script start
os.system("xdg-open https://www.youtube.com/@technicalbangla223")
time.sleep(5)
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://www.facebook.com/profile.php?id=100076466624526")

			elif fol == '3' or fol == '03':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my Github profile in your device \n")
				time.sleep(1)
				os.system("xdg-open https://github.com/shohan1122")
				...
				time.sleep(1)
				os.system("xdg-open https://t.me/shohanoffical223")
